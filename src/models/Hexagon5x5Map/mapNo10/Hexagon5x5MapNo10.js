...
class Hexagon5x5MapNo10 extends Hexagon5x5Map {
  constructor() {
    super({ label: "10" });
    this.setPlanet(-1, 2, PLANET_TYPE_EARTH);
    this.setPlanet(-1, 3, PLANET_TYPE_RED);
    this.setPlanet(1, 1, PLANET_TYPE_YELLOW);
    this.setPlanet(1, 3, PLANET_TYPE_GAIA_PLANET);
    this.setPlanet(3, 1, PLANET_TYPE_TRANSDIM);
    this.setPlanet(3, 2, PLANET_TYPE_TRANSDIM);
  }
}
export default Hexagon5x5MapNo10;
