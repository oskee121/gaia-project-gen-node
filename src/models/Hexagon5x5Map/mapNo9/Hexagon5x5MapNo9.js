...
class Hexagon5x5MapNo9 extends Hexagon5x5Map {
  constructor() {
    super({ label: "09" });
    this.setPlanet(-1, 2, PLANET_TYPE_BROWN);
    this.setPlanet(0, 2, PLANET_TYPE_BLACK);
    this.setPlanet(1, 3, PLANET_TYPE_GAIA_PLANET);
    this.setPlanet(2, 0, PLANET_TYPE_ORANGE);
    this.setPlanet(3, 1, PLANET_TYPE_TRANSDIM);
    this.setPlanet(3, 2, PLANET_TYPE_WHITE);
  }
}
export default Hexagon5x5MapNo9;
