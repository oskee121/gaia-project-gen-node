...
class Hexagon5x5MapNo1 extends Hexagon5x5Map {
  constructor() {
    super({ label: "01" });
    this.setPlanet(-1, 4, PLANET_TYPE_RED);
    this.setPlanet(0, 1, PLANET_TYPE_YELLOW);
    this.setPlanet(0, 4, PLANET_TYPE_ORANGE);
    this.setPlanet(1, 1, PLANET_TYPE_BROWN);
    this.setPlanet(2, 2, PLANET_TYPE_EARTH);
    this.setPlanet(2, 3, PLANET_TYPE_TRANSDIM);
  }
}
export default Hexagon5x5MapNo1;
