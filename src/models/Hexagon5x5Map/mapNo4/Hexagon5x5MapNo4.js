...
class Hexagon5x5MapNo4 extends Hexagon5x5Map {
  constructor() {
    super({ label: "04" });
    this.setPlanet(0, 1, PLANET_TYPE_WHITE);
    this.setPlanet(0, 2, PLANET_TYPE_ORANGE);
    this.setPlanet(1, 3, PLANET_TYPE_BROWN);
    this.setPlanet(1, 4, PLANET_TYPE_EARTH);
    this.setPlanet(2, 1, PLANET_TYPE_RED);
    this.setPlanet(3, 0, PLANET_TYPE_BLACK);
  }
}
export default Hexagon5x5MapNo4;
